...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="about" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p>Campus Connect (abbrv. C'C) is a Social Network built around the campus life limited to your University<br>
                    Whole new features like <strong>Room mate finder and Student Market!</strong>
                </p>
            </div>
        </div>
    </section>
						...
						<form role="form" action="" method="post"
							...
							<table class="registration-form center_div">
								<div class="form-group">
									<tr>
										<td><label style="color: white" class="" for="lemail">Email</label>
										<td></td>
										</td>
										<td><input
						...
						class="form-last-name form-control" id="form-last-name" required></td>
								...
								<tr>
									...
									<td colspan="3"><input type="submit"
										class="btn btn-lg btn-default" value="Login"></td>
    ...
    <br>
    <!-- Register Section -->
    <section id="register" class="container content-section text-center padbot">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>Register on C'C</h2>
                <p>Not yet registered?!! <br>Please click here to register</p>
               
                <ul class="list-inline banner-social-buttons">
                    <li>
                        <a href="fregister.jsp" class="btn btn-default btn-lg">Faculty - Register Now!</a>
                    </li>
                    <li>
                        <a href="sregister.jsp" class="btn btn-default btn-lg">Student Register Now!</a>
                    </li>
