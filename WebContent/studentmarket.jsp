															...
															<div class="panel panel-default">
																...
																<div class="panel-body">
																	<label class="radio-inline"> <input
																		...
																		type="radio" name="optradio" value="Roommate">Sell
																	</label> <label class="radio-inline"><input
																		type="radio" name="optradio" value="House">Rent</label>
																	<br> <br> <label for="address">Item
																		Description:</label> <input type="text" class="form-control"
																		id="add" name="address" /> <br> <label
																		for="address">Amount/Rent:</label> <input type="text"
